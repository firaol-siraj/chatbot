...
export default function Login() {
  ...
  useEffect(() => {
    ...
    if (err === 'oauth_failed') setError('OAuth sign-in failed. Please try again or use email/password.');
  }, [searchParams]);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-primary-950 px-4">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-20 right-20 w-96 h-96 bg-accent-violet/10 rounded-full blur-3xl" />
      </div>
